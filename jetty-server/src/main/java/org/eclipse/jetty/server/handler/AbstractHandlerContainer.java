...
public abstract class AbstractHandlerContainer extends AbstractHandler implements HandlerContainer
{
    ...
    public interface GracefulContainer extends LifeCycle, Container
    {
    ...
    public static void shutdown(GracefulContainer component) throws MultiException
    {
        ...
        List<Future<Void>> futures = component.getContainedBeans(Graceful.class).stream()
            .map(Graceful::shutdown).collect(Collectors.toList());
